...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // NEW: PDF Generation Function - using jsPDF direct text rendering with Tiro Bangla font
    async function generateInvoicePdf() {
        try {
            const pdf = new window.jspdf.jsPDF('portrait', 'pt', 'a4');

            // --- IMPORTANT: Add the Tiro Bangla font ---
            // 'Tiro Bangla' is the font name from the converter.
            // 'TiroBangla-Regular-normal.ttf' is the TTF filename given to converter.
            ...
            pdf.addFileToVFS('TiroBangla-Regular.ttf', window.font); 
            pdf.addFont('TiroBangla-Regular.ttf', 'Tiro Bangla', 'normal');
            pdf.setFont('Tiro Bangla', 'normal');
            // --- End Font Setup ---
